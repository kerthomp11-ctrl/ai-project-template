...
.NOTES
    After setup, open the workspace folder in VS Code.
...
Write-Host "  3. Attach AGENT.md and SESSION.md"
Write-Host "  4. Say: let's start"
Write-Host ""
Write-Host "GitHub Copilot authentication is handled through VS Code — no API key needed here." -ForegroundColor Yellow
Write-Host ""
